...
def generate_launch_description():
    ...
    config_dir = os.path.join(get_package_share_directory('carver_navigation'), 'config')
    config_file = os.path.join(config_dir, 'mapper_params_online_sync.yaml')

    rviz_config_dir = os.path.join(get_package_share_directory('carver_navigation'), 'rviz')
